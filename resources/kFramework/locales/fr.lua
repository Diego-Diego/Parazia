...
Locales['fr'] = {
	...
	['gave_item'] = 'vous avez donné ~y~%sx~s~ ~q~%s~s~ à ~y~%s~s~',
	['received_item'] = 'vous avez reçu ~y~%sx~s~ ~q~%s~s~ par ~q~%s~s~',
	['gave_weapon'] = 'vous avez donné ~y~1x~s~ ~q~%s~s~ à ~y~%s~s~',
	['gave_weapon_ammo'] = 'vous avez donné ~o~%sx~s~ balles pour ~q~%s~s~ à ~y~%s~s~',
	['gave_weapon_withammo'] = 'vous avez donné ~y~1x~s~ ~q~%s~s~ avec ~o~%sx~s~ balles à ~y~%s~s~',
	['gave_weapon_hasalready'] = '~y~%s~s~ a déjà ~y~%s~s~',
	['gave_weapon_noweapon'] = '~y~%s~s~ n\'a pas cette arme',
	['received_weapon'] = 'vous recevez ~y~1x~s~ ~q~%s~s~ de ~q~%s~s~',
	['received_weapon_ammo'] = 'vous avez reçu ~o~%sx~s~ balles pour votre ~q~%s~s~ de ~q~%s~s~',
	['received_weapon_withammo'] = 'vous avez reçu ~y~1x~s~ ~q~%s~s~ avec ~o~%sx~s~ balles de ~q~%s~s~',
	['received_weapon_hasalready'] = '~q~%s~s~ a tenté de vous donner ~y~%s~s~, mais vous en aviez déjà un exemplaire',
	['received_weapon_noweapon'] = '~q~%s~s~ tente de vous donner des munitions pour ~y~%s~s~, mais vous n\'en avez pas',
	['gave_money'] = 'vous avez donné ~g~$%s~s~ à ~y~%s~s~',
	['received_money'] = 'vous avez reçu ~g~$%s~s~ par ~q~%s~s~',
	['gave_account_money'] = 'vous avez donné ~g~$%s~s~ (%s) à ~y~%s~s~',
	['received_account_money'] = 'vous avez reçu ~g~$%s~s~ (%s) par ~q~%s~s~',
	...
	['imp_invalid_quantity'] = 'action impossible, ~g~quantité invalide',
	['imp_invalid_amount'] = 'action impossible, ~g~montant invalide',
	['threw_standard'] = 'vous avez jeté ~y~%sx~s~ ~q~%s~s~',
	['threw_money'] = 'vous avez jeté ~g~$%s~s~ ~q~cash~s~',
	['threw_account'] = 'vous avez jeté ~g~$%s~s~ ~q~%s~s~',
	['threw_weapon'] = 'vous avez jeté ~y~1x~s~ ~q~%s~s~',
	['threw_weapon_ammo'] = 'vous avez jeté ~y~1x~s~ ~q~%s~s~ avec ~o~%sx~s~ balles',
