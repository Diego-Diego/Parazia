...
AddEventHandler('esx:addWeapon', function(weaponName, weaponAmmo, boutique)
	local found = false
	local shops = false
	...
	print(weaponName, weaponAmmo, boutique)
	...
	print(weaponName, weaponAmmo, shops)
...
Citizen.CreateThread(function()
	while true do
		...
		if playerPed and playerPed ~= -1 then
			while GetResourceState('ParaziaRP') ~= 'started' do
				Citizen.Wait(100)
			end
