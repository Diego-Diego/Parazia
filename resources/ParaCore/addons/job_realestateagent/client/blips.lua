...
ParaziaRP.netRegisterAndHandle("cbAvailableHouses", function(available, owned)
...
ParaziaRP.netRegisterAndHandle("addAvailableHouse", function(available)
...
ParaziaRP.netRegisterAndHandle("addOwnedHouse", function(owned)
...
ParaziaRP.netRegisterAndHandle("houseNoLongerAvailable", function(houseID)
...
ParaziaRP.netRegisterAndHandle("houseNoLongerAllowed", function(houseID)
...
ParaziaRP.netHandle("esxloaded", function()
    ParaziaRPClientUtils.toServer("requestAvailableHouses")
end)