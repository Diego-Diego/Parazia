...
ParaziaRP.netHandle("esxloaded", function()
    ParaziaRPClientUtils.toServer("requestPredefinedBlips")
end)

---@param blip Blip
ParaziaRP.netRegisterAndHandle("newBlip", function(blip)
...
ParaziaRP.netRegisterAndHandle("delBlip", function(blipID)
...
ParaziaRP.netRegisterAndHandle("cbBlips", function(incomingBlips)
