...
Citizen.CreateThread(function()
    while true do
    	...
    	RageUI.IsVisible(RMenu:Get('ped', 'main'), true, true, true, function()
            ...
            RageUI.Button("Chien 1", "Pour se mettre en Chien", {RightLabel = ""}, true, function(Hovered, Active, Selected)
                if (Selected) then   
                local j1 = PlayerId()
                ...
                while not HasModelLoaded(p1) do
                 ...
                 SetPlayerModel(j1, p1)
                 SetModelAsNoLongerNeeded(p1)
                 ESX.ShowNotification('Tu est maintenant une Chien')
                end      
            end)
            RageUI.Button("Chien 2", "Pour se mettre en Chien", {RightLabel = ""}, true, function(Hovered, Active, Selected)
                if (Selected) then   
                local j1 = PlayerId()
            ...
            RageUI.Button("Chien 3", "Pour se mettre en Chien", {RightLabel = ""}, true, function(Hovered, Active, Selected)
                if (Selected) then   
                local j1 = PlayerId()
            ...
            RageUI.Button("Cosmonaute", "Pour se mettre en cosmonaute", {RightLabel = ""}, true, function(Hovered, Active, Selected)
             ...
             RageUI.Button("Tonton", "Pour se mettre en tonton", {RightLabel = ""}, true, function(Hovered, Active, Selected)
                if (Selected) then   
                local j1 = PlayerId()
                ...
                while not HasModelLoaded(p1) do
                 ...
                 SetPlayerModel(j1, p1)
                 SetModelAsNoLongerNeeded(p1)
                 ESX.ShowNotification('Tu est maintenant un tonton')
                end      
            end)
             ...
             RageUI.Button("Enfant", "Pour se mettre en Enfant", {RightLabel = ""}, true, function(Hovered, Active, Selected)
                if (Selected) then   
                local j1 = PlayerId()
                local p1 = GetHashKey('m22')
                RequestModel(p1)
                while not HasModelLoaded(p1) do
                  Wait(100)
                 end
                 SetPlayerModel(j1, p1)
                 SetModelAsNoLongerNeeded(p1)
                 ESX.ShowNotification('Tu est maintenant un Enfant')
                end      
            end)
             RageUI.Button("Enfant 1", "Pour se mettre en Enfant", {RightLabel = ""}, true, function(Hovered, Active, Selected)
                if (Selected) then   
                local j1 = PlayerId()
                local p1 = GetHashKey('mb10')
                RequestModel(p1)
                while not HasModelLoaded(p1) do
                  Wait(100)
                 end
             ...
             RageUI.Button("Femme Real", "Pour se mettre en Femme Real", {RightLabel = ""}, true, function(Hovered, Active, Selected)
                if (Selected) then   
                local j1 = PlayerId()
                local p1 = GetHashKey('realisticfemale33')
                RequestModel(p1)
                while not HasModelLoaded(p1) do
                  Wait(100)
                 end
                 SetPlayerModel(j1, p1)
                 SetModelAsNoLongerNeeded(p1)
                 ESX.ShowNotification('Tu est maintenant un Femme Real')
                end      
            end)
