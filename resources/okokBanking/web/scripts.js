				...
				setTimeout(function(){
					...
					$('#menu').html(`
						<div class="col-md-2 d-flex flex-column sidebar-s">
							...
							<div id="sidebar"></div>
							<p class="sidebar-item mt-auto logout"><i class="fas fa-sign-out-alt"></i></i> <span class="ms-1">Déconnecter</span></p>
						</div>
		...
		case 'transactions_page':
			...
			for(var i = 0; i < num; i++) {
				...
				// Sent
					...
					data = `<td class="align-middle fw500">
								Pour <span class="transactions-name">${name}</span>
								<div class="mtm3125">Expédié</div>
							</td>`;
			...
			$('#page_info').html(`
				<div class="row mb-3">
					...
					<div class="col col-md-3 pr05 pl05">
						<div class="card stats-title">
							<div class="card-body text-center">
								<h6 class="card-title">LE REVENU</h6>
	...
	if(event.data.isUpdate && selectedWindow == "bankmenu" || !event.data.isUpdate){
					...
					<div class="col-md-12">
						<div class="card last-t-card">
							<div class="card-header card-o-header text-center">
								<span class="card-o-title">Dernières transactions<span class="badge bg-primary viewall-badge" id="view_all_transactions"><i class="fas fa-eye"></i> VOIR TOUT</span></span>
							</div>
					...
					<div class="card text-center h-100 actions-card">
						...
						<div class="card-body actions-card_body">
							<div class="d-flex justify-content-center">
								<button type="button" id="depositMoneyModal" class="btn btn-blue flex-grow-1" data-bs-toggle="modal" data-bs-target="#depositModal"><i class="bi bi-upload"></i> Dépôt</button>
							</div>
							...
							<div class="d-flex justify-content-center mt4375">
								<button type="button" id="transferMoneyModal" class="btn btn-blue flex-grow-1" data-bs-toggle="modal" data-bs-target="#transferModal"><i class="fas fa-exchange-alt"></i> Transfert</button>
							</div>
						</div>
					</div>
				</div>
		...
		for(var i = 0; i < num; i++) {
			...
			// Sent
				...
				data = `<td class="align-middle lastT-name-div">
							Pour <span class="lastT-name">${name}</span>
							<div class="mtm3125">Expédié</div>
						</td>`;
			...
			<div class="col-md-7 chart-main">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card last-t-card">
							<div class="card-header card-o-header text-center">
								<span class="card-o-title">Dernières transactions<span class="badge bg-primary viewall-badge" id="view_all_transactions_society"><i class="fas fa-eye"></i> VOIR TOUT</span></span>
							</div>
							<div class="card-body" id="last-t-body">
								<table id="lastTransactionsTable">
									<tbody id="lastTransactionsData">
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center settings_info-card">
									<div class="card-body text-center fs1125">
										<span>L'IBAN a un coût de modification de ${event.data.ibanCost}€</span>
										<hr class="fff">
										<span>L'IBAN a toujours le préfixe "${event.data.ibanPrefix}"</span>
										<hr class="fff">
	...
	setTimeout(function () {
		$('#menu').html(`
			<div class="d-flex justify-content-center flex-column align-items-center">
				<span class="load"></span>
				<br>
				<div class="ldata-txt">Déconnection...</div>
			</div>
		`);
		$("#menu").fadeIn();
