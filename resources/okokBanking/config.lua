...
Config.CreditCardItem = "cb" -- Required item to access the ATM
...
Config.BankLocations = { -- To get blips and colors check this: https://wiki.gtanet.work/index.php?title=Blips
	...
	{blip = 108, blipColor = 3, blipScale = 0.9, x = 248.25, y = 222.47, z = 106.28, blipText = "Banque", BankDistance = 3},
...
Config.BotName = "ParaziaRP" -- Write the desired bot name

Config.ServerName = "ParaziaRP" -- Write your server's name
