...
--    else
--        ESX.ShowNotification("~q~Distance\n~w~Rapprochez-vous.")
--    end
--end) 
...
function identity(playerIdentity, licenses)
    Citizen.CreateThread( function()
        ...
        while endMovement > 10 do 
            ...
            DrawAdvancedText2("~q~Nom:~s~ "..playerIdentity[1].lastname, 4, {255, 255, 255, currentOpacity}, pText, containerX-.05, containerY+.330)
            DrawAdvancedText2("~q~Prénom:~s~ "..playerIdentity[1].firstname, 4, {255, 255, 255, currentOpacity}, pText, containerX-.05, containerY+.370)
            DrawAdvancedText2("~q~Age:~s~ "..playerIdentity[1].dateofbirth, 4, {255, 255, 255, currentOpacity}, pText, containerX-.05, containerY+.410)
            DrawAdvancedText2("~q~Taille:~s~ "..playerIdentity[1].height, 4, {255, 255, 255, currentOpacity}, pText, containerX-.05, containerY+.450)
            DrawAdvancedText2("~q~Sexe:~s~ "..playerIdentity[1].sex, 4, {255, 255, 255, currentOpacity}, pText, containerX-.05, containerY+.490)
...
function DroitMiranda()
    CreateThread( function()
        ...
        while endMovement > 10 do 
            ...
            CreateText("~q~Droit Miranda", 4, {255, 255, 255, currentOpacity}, 0.7, 0.48, 0.155)
