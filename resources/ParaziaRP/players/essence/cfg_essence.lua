...
StringsLocalFuel = {
	...
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~ pour acheter un jerrican de ~g~$" .. JerryCanCostFuel,
	...
	NotEnoughCash = "~q~Pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~g~E ~w~ pour remplir le jerrican pour ",
