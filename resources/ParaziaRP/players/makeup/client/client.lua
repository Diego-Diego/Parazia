            ...
            RageUI.Button("Valider votre maquillage", nil, {RightLabel = "100$"}, true, {
                onSelected = function()
                    ESX.TriggerServerCallback("barber:getmoney", function(cb)
                        if cb == true then 
                            ESX.ShowAdvancedNotification("~q~ParaziaRP Information", "Salon de Maquillage", "Vous avez payé votre maquillage avec succès !\nA bientôt", "CHAR_SEALIFE", 8)
                            ...
                            ESX.ShowAdvancedNotification("~q~ParaziaRP Information", "Salon de Maquillage", "Vous ne disposez pas des fonds nécéssaires !", "CHAR_SEALIFE", 8)
                            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
                                TriggerEvent('skinchanger:loadSkin', skin)
                            end) 
                            SetPlayerControl(PlayerId(), true, 12)
