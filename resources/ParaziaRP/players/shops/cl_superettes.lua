...
--LTDItemDiamond = {
    --{name = 'jusleechi', label = 'Jus de Leechi - VIP ~q~Diamond', price = 50},
    --{name = 'hotdog', label = 'Hot-dog - VIP ~q~Diamond', price = 50},
--}
            ...
            RageUI.Button(v.label, nil, {RightLabel = "~g~".. v.price.."$"}, true, {
                onSelected = function()
                    ...
                    if vip ~= 0 then
                        ...
                        ESX.ShowNotification(' ~n~Vous devez être minimum VIP ~y~Gold')
                    end
                end
            })
        end
            ...
            RageUI.Button(v.label, nil, {RightLabel = "~g~".. v.price.."$"}, true, {
                onSelected = function()
                    ...
                    if vip == 2 then
                        ...
                        ESX.ShowNotification(' ~n~Vous devez être minimum VIP ~q~Diamond')
                    end
                end
            })
        end]]
