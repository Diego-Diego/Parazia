...
Sexe = {
    ...
    {name = "Baiser quelqu'un", value = "rcmpaparazzo_2",  anim ="shag_loop_a",loop = 1, command = "baiser"},
    {name = "Se faire baiser", value = "rcmpaparazzo_2",  anim ="shag_loop_poppy",loop = 1, command = "baiser2"},
...
Musique = {
        {
            ...
            type11  = " ~q~↓↓~s~ Danse bâtons lumineux ~q~↓↓",
            glowstickdanse = {
