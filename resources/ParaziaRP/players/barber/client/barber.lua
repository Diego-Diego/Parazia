            ...
            RageUI.Button("Payer la coupe", nil, {RightLabel = "~g~100 $"}, true, {
                onSelected = function()
                    ESX.TriggerServerCallback("barber:getmoney", function(cb)
                        if cb == true then
                            buy = true
                            ESX.ShowAdvancedNotification("~q~ParaziaRP Information", "Barber Shop", "Vous avez payé votre coupe avec succès !\nA bientôt", "CHAR_SEALIFE", 8)
                            ...
                            ESX.ShowAdvancedNotification("~q~ParaziaRP Information", "Barber Shop", "Vous ne disposez pas des fonds nécéssaires !", "CHAR_SEALIFE", 8)
