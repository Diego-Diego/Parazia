...
function openFarmBuilders()
    ...
    while main do
        ...
        RageUI.IsVisible(main, function()
            RageUI.Separator("↓ ~q~Création d\'activité ~w~ ↓")
            ...
            RageUI.Separator("↓ ~q~Traitement ~w~ ↓")
            ...
            RageUI.Separator("↓ ~q~Prix de Vente ~w~ ↓")
            ...
            --RageUI.Separator("↓ ~q~Evenements Légal ~w~ ↓")
        end)
