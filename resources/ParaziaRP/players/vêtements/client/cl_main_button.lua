...
OpenVetementShop = function()
    ...
    while mainvet do 
        ...
        RageUI.IsVisible(mainvet, function()
            ...
            RageUI.Button("> Valider la tenue sans l'enregister", nil, {BackgroundColor = {R = 0, G = 255, B = 0, A = 255}, RightLabel = '~g~500 $'}, true, {
                onSelected = function()  
        ...
        RageUI.IsVisible(garderobe, function()
            ...
            if ClothesPlayer ~= nil then 
                ...
                if not NoTenueDispo then 
                    RageUI.Separator("~g~Aucune tenue disponible")
                end
            else
                RageUI.Separator("~g~Vous n'avez pas de tenue")
            end
        end)
        ...
        RageUI.IsVisible(deposittenue, function()
            if ClothesPlayer ~= nil  then 
                ...
                if not OneTenueDeposit then 
                    RageUI.Separator("~g~Vous n'avez pas de tenue déposer")
                end
            end
        end)
