...
function Menuf6GalaxyClub()
    local fGalaxyClubf6 = MowgliUI.CreateMenu("", "Interactions")
    fGalaxyClubf6:SetRectangleBanner(153, 50, 204)
    MowgliUI.Visible(fGalaxyClubf6, not MowgliUI.Visible(fGalaxyClubf6))
    while fGalaxyClubf6 do
        Citizen.Wait(0)
            MowgliUI.IsVisible(fGalaxyClubf6, true, true, true, function()
                ...
                if not MowgliUI.Visible(fGalaxyClubf6) then
...
function CoffreGalaxyClub()
    local CGalaxyClub = MowgliUI.CreateMenu("", "GalaxyClub")
    CGalaxyClub:SetRectangleBanner(153, 50, 204)
        MowgliUI.Visible(CGalaxyClub, not MowgliUI.Visible(CGalaxyClub))
            while CGalaxyClub do
            Citizen.Wait(0)
            MowgliUI.IsVisible(CGalaxyClub, true, true, true, function()
            ...
            if not MowgliUI.Visible(CGalaxyClub) then
...
function GarageGalaxyClub()
  local GGalaxyClub = MowgliUI.CreateMenu("", "GalaxyClub")
  GGalaxyClub:SetRectangleBanner(153, 50, 204)
    MowgliUI.Visible(GGalaxyClub, not MowgliUI.Visible(GGalaxyClub))
        while GGalaxyClub do
            Citizen.Wait(0)
                MowgliUI.IsVisible(GGalaxyClub, true, true, true, function()
            ...
            if not MowgliUI.Visible(GGalaxyClub) then
...
function GalaxyClubRetirerobjet()
    local StockGalaxyClub = MowgliUI.CreateMenu("", "GalaxyClub")
    StockGalaxyClub:SetRectangleBanner(153, 50, 204)
    ESX.TriggerServerCallback('fGalaxyClub:getStockItems', function(items) 
    itemstock = items
   
    MowgliUI.Visible(StockGalaxyClub, not MowgliUI.Visible(StockGalaxyClub))
        while StockGalaxyClub do
            Citizen.Wait(0)
                MowgliUI.IsVisible(StockGalaxyClub, true, true, true, function()
            ...
            if not MowgliUI.Visible(StockGalaxyClub) then
...
function GalaxyClubDeposerobjet()
    local StockPlayer = MowgliUI.CreateMenu("", "GalaxyClub")
