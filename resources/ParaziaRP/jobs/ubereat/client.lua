...
function Menuf6UberEat()
    local fUberEatf6 = MowgliUI.CreateMenu("", "Interactions")
    fUberEatf6:SetRectangleBanner(153, 50, 204)
    MowgliUI.Visible(fUberEatf6, not MowgliUI.Visible(fUberEatf6))
    while fUberEatf6 do
        Citizen.Wait(0)
            MowgliUI.IsVisible(fUberEatf6, true, true, true, function()
                ...
                if not MowgliUI.Visible(fUberEatf6) then
...
function CoffreUberEat()
    local CUberEat = MowgliUI.CreateMenu("", "UberEat")
    CUberEat:SetRectangleBanner(153, 50, 204)
        MowgliUI.Visible(CUberEat, not MowgliUI.Visible(CUberEat))
            while CUberEat do
            Citizen.Wait(0)
            MowgliUI.IsVisible(CUberEat, true, true, true, function()
            ...
            if not MowgliUI.Visible(CUberEat) then
...
function GarageUberEat()
  local GUberEat = MowgliUI.CreateMenu("", "UberEat")
  GUberEat:SetRectangleBanner(153, 50, 204)
    MowgliUI.Visible(GUberEat, not MowgliUI.Visible(GUberEat))
        while GUberEat do
            Citizen.Wait(0)
                MowgliUI.IsVisible(GUberEat, true, true, true, function()
            ...
            if not MowgliUI.Visible(GUberEat) then
...
function UberEatRetirerobjet()
    local StockUberEat = MowgliUI.CreateMenu("", "UberEat")
    StockUberEat:SetRectangleBanner(153, 50, 204)
    ESX.TriggerServerCallback('fUberEat:getStockItems', function(items) 
    itemstock = items
   
    MowgliUI.Visible(StockUberEat, not MowgliUI.Visible(StockUberEat))
        while StockUberEat do
            Citizen.Wait(0)
                MowgliUI.IsVisible(StockUberEat, true, true, true, function()
            ...
            if not MowgliUI.Visible(StockUberEat) then
...
function UberEatDeposerobjet()
    local StockPlayer = MowgliUI.CreateMenu("", "UberEat")
