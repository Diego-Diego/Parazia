    ...
    Citizen.CreateThread(function()
        while AuTravaillebucheron do
            ...
            while not EnAction and AuTravaillebucheron do
                Citizen.Wait(1)
                MowgliUI.Text({message = "Dirigez-vous vers le point GPS pour abattre un arbre"})
                ...
                if dst <= 3.0 and AuTravaillebucheron then
                    ...
                    if IsControlJustPressed(1, 51) and dst <= 3.0 then
                        ...
                        while dst > 3.0 do
                            ...
                            MowgliUI.Text({message = "Dirigez-vous vers le point GPS pour déposer l'arbre couper"})
                        end
