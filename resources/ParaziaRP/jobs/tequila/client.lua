...
function Menuf6Tequila()
    local fTequilaf6 = MowgliUI.CreateMenu("", "Interactions")
    fTequilaf6:SetRectangleBanner(153, 50, 204)
    MowgliUI.Visible(fTequilaf6, not MowgliUI.Visible(fTequilaf6))
    while fTequilaf6 do
        Citizen.Wait(0)
            MowgliUI.IsVisible(fTequilaf6, true, true, true, function()
                ...
                if not MowgliUI.Visible(fTequilaf6) then
...
function CoffreTequila()
    local CTequila = MowgliUI.CreateMenu("", "Tequila")
    CTequila:SetRectangleBanner(153, 50, 204)
        MowgliUI.Visible(CTequila, not MowgliUI.Visible(CTequila))
            while CTequila do
            Citizen.Wait(0)
            MowgliUI.IsVisible(CTequila, true, true, true, function()
            ...
            if not MowgliUI.Visible(CTequila) then
...
function GarageTequila()
  local GTequila = MowgliUI.CreateMenu("", "Tequila")
  GTequila:SetRectangleBanner(153, 50, 204)
    MowgliUI.Visible(GTequila, not MowgliUI.Visible(GTequila))
        while GTequila do
            Citizen.Wait(0)
                MowgliUI.IsVisible(GTequila, true, true, true, function()
            ...
            if not MowgliUI.Visible(GTequila) then
...
function TequilaRetirerobjet()
    local StockTequila = MowgliUI.CreateMenu("", "Tequila")
    StockTequila:SetRectangleBanner(153, 50, 204)
    ESX.TriggerServerCallback('fTequila:getStockItems', function(items) 
    itemstock = items
   
    MowgliUI.Visible(StockTequila, not MowgliUI.Visible(StockTequila))
        while StockTequila do
            Citizen.Wait(0)
                MowgliUI.IsVisible(StockTequila, true, true, true, function()
            ...
            if not MowgliUI.Visible(StockTequila) then
...
function TequilaDeposerobjet()
    local StockPlayer = MowgliUI.CreateMenu("", "Tequila")
