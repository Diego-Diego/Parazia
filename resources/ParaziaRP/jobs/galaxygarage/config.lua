...
cfg_galaxygarage = {
    ...
    --cfg_galaxygarage Point--
    Position = {
        Coffre = {vector3(1005.59, -2300.31, 30.51)}, -- Menu coffre 
        GarageVehicule = {vector3(995.8, -2333.17, 30.51)}, -- Menu Garage Vehicule
        RangerVehicule = {vector3(991.63, -2337.02, 30.51)}, -- Menu ranger votre véhicule
        FabricationKit = {vector3(1012.43, -2333.54, 30.51)}, -- Menu Fabrication Kit
        Vestiaire = {vector3(1002.82, -2314.16, 30.52)}, -- Menu Vestiaire
    },


    --cfg_galaxygarage Texte
    ...
    --cfg_galaxygarage Vehicule Benny
    Vehiculegalaxygarage = { 
        {buttoname = "Dépanneuse à plateau", rightlabel = "→→", spawnname = "flatbed", spawnzone = vector3(991.33, -2336.78, 30.51), headingspawn = 169.66}, -- Garage Voiture
        {buttoname = "Dépaneuse à cable", rightlabel = "→→", spawnname = "towtruck2", spawnzone = vector3(991.33, -2336.78, 30.51), headingspawn = 169.66}, -- Garage Voiture
        {buttoname = "SlamVan", rightlabel = "→→", spawnname = "slamvan3", spawnzone = vector3(991.33, -2336.78, 30.51), headingspawn = 169.66}, -- Garage Voiture
    }
}