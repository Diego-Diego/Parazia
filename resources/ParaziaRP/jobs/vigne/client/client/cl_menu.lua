...
local open = false 
local mainMenu8 = RageUI.CreateMenu('', '~q~Interaction')
local subMenu8 = RageUI.CreateSubMenu(mainMenu8, "", "~q~Interaction")
local subMenu10 = RageUI.CreateSubMenu(mainMenu8, "", "~q~Interaction")
