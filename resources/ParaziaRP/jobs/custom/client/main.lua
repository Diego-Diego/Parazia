...
function resetMenu()
	if not mainMenu and PlayerData.job then
		...
		if PlayerData.job.name == 'mecano' then
			mainMenu = RageUI.CreateMenu("", "~q~Benny's")
			society = 'society_mecano'
		elseif PlayerData.job.name == 'lscustom' then
			mainMenu = RageUI.CreateMenu("", "~q~LS Custom")
			society = 'society_lscustom'
		elseif PlayerData.job.name == 'mcustom' then
			mainMenu = RageUI.CreateMenu("", "~q~ MCustom")
			society = 'society_mcustom'
		end
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			if (PlayerData.job and PlayerData.job.name == 'mecano' or PlayerData.job and PlayerData.job.name == 'lscustom' or PlayerData.job and PlayerData.job.name == 'mcustom') or not cfg_custom.IsMecanoJobOnly and not lsMenuIsShowed then
				isInLSMarker = false
			...
			if IsControlJustReleased(0, 38) and not lsMenuIsShowed and isInLSMarker then
				if (PlayerData.job.name == 'mecano' or PlayerData.job.name == 'lscustom' or PlayerData.job.name == 'mcustom') or not cfg_custom.IsMecanoJobOnly then
					--vehPedIsIn = GetVehiclePedIsIn(playerPed, false)
					terminatePurchase()
					getCarPrice()
					...
					if ((vehicleClass ~= 8 or not cfg_custom.IsMotorCycleBikerOnly) and PlayerData.job.name == 'mecano') or 
						((vehicleClass ~= 8 or not cfg_custom.IsMotorCycleBikerOnly) and PlayerData.job.name == 'lscustom') or
						 ((vehicleClass ~= 8 or not cfg_custom.IsMotorCycleBikerOnly) and PlayerData.job.name == 'mcustom') 
					then
					...
					elseif tempColorParts['mod'][colorPartIndex] == 'tireSmoke' then 
						RageUI.Button(smokeColorIndex[1]['label'] .. " [" .. smokeColorIndex[1]['index'] .. "]", nil, {}, true, {
							onSelected = function(Index)
								local smokeRedValue = KeyboardInput("Taux de rouge","", "", 15)
						...
						RageUI.Button(smokeColorIndex[2]['label'] .. " [" .. smokeColorIndex[2]['index'] .. "]", nil, {}, true, {
							onSelected = function(Index)
								local smokeGreenValue = KeyboardInput("Taux de vert","", "", 15)
						...
						RageUI.Button(smokeColorIndex[3]['label'] .. " [" .. smokeColorIndex[3]['index'] .. "]", nil, {}, true, {
							onSelected = function(Index)
								local smokeBlueValue = KeyboardInput("Taux de bleu","", "", 15)
			...
			RageUI.IsVisible(neonMenu, function()
					...
					if neon1 or neon2 or neon3 or neon4 then
						RageUI.Button(neonIndex[1]['label'] .. " [" .. neonIndex[1]['index'] .. "]", nil, {}, true, {
							onSelected = function(Index)
								local neonRedValue = KeyboardInput("Taux de rouge","", "", 15)
						...
						RageUI.Button(neonIndex[2]['label'] .. " [" .. neonIndex[2]['index'] .. "]", nil, {}, true, {
							onSelected = function(Index)
								local neonGreenValue = KeyboardInput("Taux de vert","", "", 15)
						...
						RageUI.Button(neonIndex[3]['label'] .. " [" .. neonIndex[3]['index'] .. "]", nil, {}, true, {
							onSelected = function(Index)
								local neonBlueValue = KeyboardInput("Taux de bleu","", "", 15)
