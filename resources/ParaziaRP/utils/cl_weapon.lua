...
local weapons = {
	...
	[`WEAPON_MG`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.07, infiniteAmmo = false}},
	[`WEAPON_COMBATMG`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.08, infiniteAmmo = false}},
	[`WEAPON_COMBATMG_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.085, infiniteAmmo = false}},
	[`WEAPON_GUSENBERG`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.05, infiniteAmmo = false}},

	[`WEAPON_ASSAULTRIFLE`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.07, infiniteAmmo = false}},
	[`WEAPON_ASSAULTRIFLE_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.075, infiniteAmmo = false}},
	[`WEAPON_CARBINERIFLE`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.06, infiniteAmmo = false}},
	[`WEAPON_CARBINERIFLE_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.065, infiniteAmmo = false}},
	[`WEAPON_ADVANCEDRIFLE`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.06, infiniteAmmo = false}},
	[`WEAPON_SPECIALCARBINE`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.06, infiniteAmmo = false}},
	[`WEAPON_SPECIALCARBINE_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.075, infiniteAmmo = false}},
	[`WEAPON_BULLPUPRIFLE`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.05, infiniteAmmo = false}},
	[`WEAPON_BULLPUPRIFLE_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.065, infiniteAmmo = false}},
	[`WEAPON_COMPACTRIFLE`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.05, infiniteAmmo = false}},
	[`WEAPON_SCAR17FM`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.05, infiniteAmmo = false}},
	[`WEAPON_M4A1FM`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.05, infiniteAmmo = false}},

	[`WEAPON_PUMPSHOTGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.07, infiniteAmmo = false}},
	[`WEAPON_PUMPSHOTGUN_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.085, infiniteAmmo = false}},
	[`WEAPON_SAWNOFFSHOTGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.06, infiniteAmmo = false}},
	[`WEAPON_BULLPUPSHOTGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.08, infiniteAmmo = false}},
	[`WEAPON_ASSAULTSHOTGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.12, infiniteAmmo = false}},
	[`WEAPON_MUSKET`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.04, infiniteAmmo = false}},
	[`WEAPON_HEAVYSHOTGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.13, infiniteAmmo = false}},
	[`WEAPON_DBSHOTGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.05, infiniteAmmo = false}},
	[`WEAPON_AUTOSHOTGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.08, infiniteAmmo = false}},

	[`WEAPON_SNIPERRIFLE`] = {parameters = {anim = true, onlyBag = false, scoped = true, shakeCam = 0.2, infiniteAmmo = false}},
	[`WEAPON_HEAVYSNIPER`] = {parameters = {anim = true, onlyBag = false, scoped = true, shakeCam = 0.3, infiniteAmmo = false}},
	[`WEAPON_HEAVYSNIPER_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = true, shakeCam = 0.35, infiniteAmmo = false}},
	[`WEAPON_MARKSMANRIFLE`] = {parameters = {anim = true, onlyBag = false, scoped = true, shakeCam = 0.1, infiniteAmmo = false}},
	[`WEAPON_MARKSMANRIFLE_MK2`] = {parameters = {anim = true, onlyBag = false, scoped = true, shakeCam = 0.1, infiniteAmmo = false}},

	[`WEAPON_GRENADELAUNCHER`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.08, infiniteAmmo = false}},
	[`WEAPON_RPG`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.9, infiniteAmmo = false}},
	[`WEAPON_STINGER`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[`WEAPON_MINIGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.2, infiniteAmmo = false}},
	[`WEAPON_FIREWORK`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.5, infiniteAmmo = false}},
	[`WEAPON_RAILGUN`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 1.0, infiniteAmmo = false}},
	[`WEAPON_HOMINGLAUNCHER`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.9, infiniteAmmo = false}},
	[`WEAPON_COMPACTLAUNCHER`] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0.08, infiniteAmmo = false}},
				...
				if (weapons[newWeap] ~= nil) and (weapons[newWeap].parameters.onlyBag) then
					...
					if ListBags[bagIndex] ~= nil then
						...
						if DoesEntityExist(vehicle) then
							...
							ESX.ShowNotification("~q~Action Impossible~s~ : \n\nVous devez disposer d'un sac ou être proche d'une voiture.")
							continue = false
						end
					end
				end
...
AddEventHandler('nwx:flashballed', function()
	wait = 2
	knockedOut = true
	ESX.ShowNotification("~q~Tu as été mis KO par une flashball !")
end)
...
RegisterNetEvent('ParaziaRP:proofSmoke')
AddEventHandler('ParaziaRP:proofSmoke', function(toBeProof)
