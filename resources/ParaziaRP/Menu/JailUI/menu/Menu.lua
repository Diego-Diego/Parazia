...
---@return JailUIMenus
---@public
function JailUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = JailUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = JailUI.UI.Style[JailUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = JailUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + JailUI.Settings.Items.Subtitle.Text.X, Menu.Y + JailUI.Settings.Items.Subtitle.Text.Y, 0, JailUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, JailUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, JailUI.Menus)
end
...
---@return JailUIMenus
---@public
function JailUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = JailUI.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function JailUI.Menus:SetTitle(Title)
    self.Title = Title
end

function JailUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function JailUI.Menus:GetStyleSize()
...
---@return void
---@public
function JailUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function JailUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function JailUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function JailUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function JailUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + JailUI.Settings.Items.Subtitle.Text.X, self.Y + JailUI.Settings.Items.Subtitle.Text.Y, 0, JailUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, JailUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function JailUI.Menus:SetPageCounter(Subtitle)
    self.PageCounter = Subtitle
end

function JailUI.Menus:SetSizeWidth(Value)
    local witdh
...
---@return nil
---@public
function JailUI.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function JailUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function JailUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function JailUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function JailUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "DynastyCommonGrrr", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function JailUI.Menus:Closable(boolean)
...
function JailUI.Menus:AddInstructionButton(button)
...
function JailUI.Menus:RemoveInstructionButton(button)
...
function JailUI.Menus:UpdateInstructionalButtons(Visible)
