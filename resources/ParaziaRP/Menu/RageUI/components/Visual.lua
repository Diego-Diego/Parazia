...
RegisterNetEvent("MowgliUI:Popup")
AddEventHandler("MowgliUI:Popup", function(array)
    MowgliUI.Popup(array)
end)

---Popup
---@param array table
---@public
function MowgliUI.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function MowgliUI.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
