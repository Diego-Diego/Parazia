...
---@return table
---@public
function MowgliUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = MowgliUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = MowgliUI.UI.Style[MowgliUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = MowgliUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + MowgliUI.Settings.Items.Subtitle.Text.X, Menu.Y + MowgliUI.Settings.Items.Subtitle.Text.Y, 0, MowgliUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, MowgliUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, MowgliUI.Menus)
end
...
---@return table
---@public
function MowgliUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function MowgliUI.Menus:SetTitle(Title)
    self.Title = Title
end

function MowgliUI.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function MowgliUI.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function MowgliUI.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function MowgliUI.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function MowgliUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function MowgliUI.Menus:GetStyleSize()
...
---@return void
---@public
function MowgliUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function MowgliUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function MowgliUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function MowgliUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function MowgliUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + MowgliUI.Settings.Items.Subtitle.Text.X, self.Y + MowgliUI.Settings.Items.Subtitle.Text.Y, 0, MowgliUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, MowgliUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function MowgliUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function MowgliUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function MowgliUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function MowgliUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function MowgliUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function MowgliUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "kikizizinazi", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function MowgliUI.Menus:Closable(boolean)
...
function MowgliUI.Menus:AddInstructionButton(button)
...
function MowgliUI.Menus:RemoveInstructionButton(button)
...
function MowgliUI.Menus:UpdateInstructionalButtons(Visible)
