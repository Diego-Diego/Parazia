			...
			elseif account == nil then
				...
				if xTarget ~= nil then
					MySQL.Async.execute('INSERT INTO billing (identifier, sender, target_type, target, label, amount) VALUES (@identifier, @sender, @target_type, @target, @label, @amount)', {
						...
						TriggerClientEvent('esx:showNotification', target, _U('received_invoice'))
						TriggerClientEvent('esx_billing:newBill', target)
						sendToDiscord('ParaziaRP - LOGS', '[FACTURE] ' ..xPlayer.getName().. ' viens de donner une facture à l\'ID : ' ..target.. ' montant : ' ..amount.. '', 3145658)
...
function sendToDiscord (name,message,color)
	...
	local DiscordWebHook = "https://discord.com/api/webhooks/994015906327969812/yEs8tFvFbsy9iQV1KnYLRvjieLtRXKRHJVzCVGXVHLOP21IG2NksocRbxA9JUpCjvh3r"
