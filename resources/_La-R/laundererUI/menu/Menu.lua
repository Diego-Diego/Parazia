...
---@param B number
---@param A number
---@return LaundererUIMenus
---@public
function LaundererUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = LaundererUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = LaundererUI.UI.Style[LaundererUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = LaundererUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + LaundererUI.Settings.Items.Subtitle.Text.X, Menu.Y + LaundererUI.Settings.Items.Subtitle.Text.Y, 0, LaundererUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, LaundererUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, LaundererUI.Menus)
end
...
---@return LaundererUIMenus
---@public
function LaundererUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = LaundererUI.CreateMenu(Title or ParentMenu.Title, Subtitle or string.upper(ParentMenu.Subtitle), X or ParentMenu.X, Y or ParentMenu.Y)
...
function LaundererUI.Menus:DisplayHeader(boolean)
    self.Display.Header = boolean;
    return self.Display.Header;
end

function LaundererUI.Menus:DisplayGlare(boolean)
    self.Display.Glare = boolean;
    return self.Display.Glare;
end

function LaundererUI.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function LaundererUI.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function LaundererUI.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function LaundererUI.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function LaundererUI.Menus:SetTitle(Title)
    self.Title = Title
end

function LaundererUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function LaundererUI.Menus:GetStyleSize()
...
---@return void
---@public
function LaundererUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function LaundererUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function LaundererUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function LaundererUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function LaundererUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + LaundererUI.Settings.Items.Subtitle.Text.X, self.Y + LaundererUI.Settings.Items.Subtitle.Text.Y, 0, LaundererUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, LaundererUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function LaundererUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function LaundererUI.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function LaundererUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function LaundererUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function LaundererUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function LaundererUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function LaundererUI.Menus:Closable(boolean)
...
function LaundererUI.Menus:AddInstructionButton(button)
...
function LaundererUI.Menus:RemoveInstructionButton(button)
...
function LaundererUI.Menus:UpdateInstructionalButtons(Visible)
