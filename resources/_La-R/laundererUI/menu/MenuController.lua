...
---@return nil
---@public
function LaundererUI.GoUp(Options)
    ...
    if CurrentMenu ~= nil then
        ...
        if CurrentMenu() then
            if (Options ~= 0) then
                ...
                local Audio = LaundererUI.Settings.Audio
                LaundererUI.PlaySound(Audio[Audio.Use].Error.audioName, Audio[Audio.Use].Error.audioRef)
            end
        end
    end
end
...
---@return nil
---@public
function LaundererUI.GoDown(Options)
    local CurrentMenu = LaundererUI.CurrentMenu;
    if CurrentMenu ~= nil then
        Options = CurrentMenu.Options
        if CurrentMenu() then
...
function LaundererUI.GoActionControl(Controls, Action)
...
function LaundererUI.GoActionControlSlider(Controls, Action)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            if CurrentMenu.Open then
                ...
                LaundererUI.Options = CurrentMenu.Options
                ...
                for i = 1, #ControlActions do
                    LaundererUI.GoActionControl(Controls, ControlActions[i])
                end

                LaundererUI.GoActionControlSlider(Controls, 'SliderLeft')
                LaundererUI.GoActionControlSlider(Controls, 'SliderRight')
...
---@return nil
---@public
function LaundererUI.Navigation()
    local CurrentMenu = LaundererUI.CurrentMenu;
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Navigation) then
            ...
            if LaundererUI.Options > CurrentMenu.Pagination.Total then
                ...
                if CurrentMenu.EnableMouse then
                    UpHovered = LaundererUI.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height)
                    DownHovered = LaundererUI.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + LaundererUI.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height)

                    if CurrentMenu.Controls.Click.Active then
                        if UpHovered then
                            LaundererUI.GoUp(LaundererUI.Options)
                        elseif DownHovered then
                            LaundererUI.GoDown(LaundererUI.Options)
                        end
                    end

                    if UpHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end

                    if DownHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + LaundererUI.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + LaundererUI.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end
                else
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + LaundererUI.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, LaundererUI.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                end
                RenderSprite(LaundererUI.Settings.Items.Navigation.Arrows.Dictionary, LaundererUI.Settings.Items.Navigation.Arrows.Texture, CurrentMenu.X + LaundererUI.Settings.Items.Navigation.Arrows.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + LaundererUI.Settings.Items.Navigation.Arrows.Y + CurrentMenu.SubtitleHeight + LaundererUI.ItemOffset, LaundererUI.Settings.Items.Navigation.Arrows.Width, LaundererUI.Settings.Items.Navigation.Arrows.Height)
                LaundererUI.ItemOffset = LaundererUI.ItemOffset + (LaundererUI.Settings.Items.Navigation.Rectangle.Height * 2)
            end
        end
    end
end
