...
local SettingsSlider = {
    Background = { X = 265, Y = 14.5, Width = 150, Height = 9 },
    Slider = { X = 265, Y = 14.5, Width = 150, Height = 9 },
    LeftArrow = { Dictionary = "commonmenutu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 0, Height = 0 },
    RightArrow = { Dictionary = "commonmenutu", Texture = "arrowright", X = 400, Y = 11.5, Width = 0, Height = 0 },
}
...
function RageUI.SliderProgressVide(Label, ProgressStart, ProgressMax, Description, Style, Enabled, Actions)
